        ...
        Column {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                var newState = root.headerCheckState !== "all"; // none/partial → true; all → false

                                // 批量更新所有行，只调用一次 updateHeaderCheckState
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    radius: root.radius * 0.3

                    // 安全初始化 checked，默认为 false
